...
class BasketFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val BasketViewModel =
            ViewModelProvider(this).get(BasketViewModel::class.java).apply {
                BasketViewModelFactory((application as ProductsApplications).repository)
                val simpleCallback =
                ...
                allProducts.observe(viewLifecycleOwner) { notes ->
